...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    class Program {
       ...
       * @param {WebGLShader | null} vertexShader - The vertex shader.
       * @param {WebGLShader | null} fragmentShader - The fragment shader.
       */
      /*******  908afeab-99b0-4ad0-b6f7-ed6bd4e138f9  *******/ constructor(
        vertexShader: WebGLShader | null,
        fragmentShader: WebGLShader | null
      ) {
